...
- [x] Implement Spectator-only entity UUID teleportation with chunk streaming and acknowledgement
...
- [x] Decode direct difficulty-lock requests and preserve authoritative/Hardcore lock state
